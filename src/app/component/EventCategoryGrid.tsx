      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
        {services.map((service, index) => (
          <Link
            ...
            prefetch={true} // this is the default, but makes it explicit
          >
            <div className="group cursor-pointer bg-transparent shadow shadow-gray-400 min-h-[310px] sm:min-h-[400px] h-auto w-full p-10 flex flex-col justify-center items-center text-center hover:bg-[#424138] hover:text-white active:bg-[#bec0b4] active:text-white transition duration-300">
